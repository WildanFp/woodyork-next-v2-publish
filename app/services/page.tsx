    ...
    <main className="bg-black text-white min-h-screen">
      ...
      <header className="p-6 md:p-8 lg:p-10 flex justify-between items-center">
        ...
        <nav className="hidden md:flex space-x-10 text-base">
          ...
          <Link href="/services" className="text-amber-300 hover:text-amber-200 transition-colors duration-300">
            services
          </Link>
      ...
      <section className="py-20 px-4 md:px-8 lg:px-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            ...
            <AnimatedSection key={i} animation="fade-in" delay={i * 100} className="hover-lift">
